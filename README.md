...
## AI usage
Copilot (version 1.7.4421) was for this project. It was used to help with writing docstrings and generating regex expressions for sentence extraction. Note that it will be disclosed in the comment the code was generated by Copilot.
